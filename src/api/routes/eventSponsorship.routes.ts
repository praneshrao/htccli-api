...
import * as controller from "../controllers/eventSponsorship.controller";
import { CreateEventSponsorshipDTO, UpdateEventSponsorshipDTO } from '../dto/eventSponsorship.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/eventSponsorship.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateEventSponsorshipDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateEventSponsorshipDTO = req.body

...
import * as controller from "../controllers/recurrenceType.controller";
import { CreateRecurrenceTypeDTO, UpdateRecurrenceTypeDTO } from '../dto/recurrenceType.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/recurrenceType.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateRecurrenceTypeDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateRecurrenceTypeDTO = req.body

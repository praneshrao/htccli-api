...
import * as controller from "../controllers/sponsorshipType.controller";
import { CreateSponsorshipTypeDTO, UpdateSponsorshipTypeDTO } from '../dto/sponsorshipType.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/sponsorshipType.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateSponsorshipTypeDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateSponsorshipTypeDTO = req.body

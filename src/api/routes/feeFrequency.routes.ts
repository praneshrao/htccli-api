...
import * as controller from "../controllers/feeFrequency.controller";
import { CreateFeeFrequencyDTO, UpdateFeeFrequencyDTO } from '../dto/feeFrequency.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/feesFrequency.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateFeeFrequencyDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateFeeFrequencyDTO = req.body

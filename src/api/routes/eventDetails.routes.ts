...
import * as controller from "../controllers/eventDetails.controller";
import { CreateEventDetailsDTO, UpdateEventDetailsDTO } from '../dto/eventDetails.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/eventDetails.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateEventDetailsDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateEventDetailsDTO = req.body

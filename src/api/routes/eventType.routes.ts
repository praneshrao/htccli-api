...
import * as controller from "../controllers/eventType.controller";
import { CreateEventTypeDTO, UpdateEventTypeDTO } from '../dto/eventType.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/eventType.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateEventTypeDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateEventTypeDTO = req.body

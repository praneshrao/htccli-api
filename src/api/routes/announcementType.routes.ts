...
import * as controller from "../controllers/announcementType.controller";
import { CreateAnnouncementTypeDTO, UpdateAnnouncementTypeDTO } from '../dto/announcementType.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/announcementType.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateAnnouncementTypeDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateAnnouncementTypeDTO = req.body

...
import * as controller from "../controllers/galleryType.controller";
import { CreateGalleryTypeDTO, UpdateGalleryTypeDTO } from '../dto/galleryType.dto';
import validateResource from '../../middleware/validateResource';
import { CreateInput, UpdateInput, createScheme, updateSchema } from '../../schema/galleryType.schema';
...
_router.put('/:Id', validateResource(updateSchema), async (req: Request<UpdateInput["params"]>, res: Response) => {
    const id = Number(req.params.Id);
    const payload:UpdateGalleryTypeDTO = req.body
...
_router.post('/', validateResource(createScheme), async (req: Request<CreateInput["body"]>, res: Response) => {
    const payload:CreateGalleryTypeDTO = req.body

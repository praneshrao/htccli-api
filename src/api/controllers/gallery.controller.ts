import * as service from "../../db/services/gallery.service";
import { CreateGalleryDTO as CreateDTO, UpdateAnnouncementDTO as UpdateDTO } from "../dto/gallery.dto";
import { galleryAttributes as T} from "../interfaces";

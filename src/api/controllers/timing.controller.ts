import * as service from "../../db/services/timing.service";
import { CreateTimingsDTO as CreateDTO, UpdateTimingsTypeDTO as UpdateDTO } from "../dto/timings.dto";
import { timingAttributes as T} from "../interfaces";
